...
extern void _mlir_ciface_vector_scale(StridedMemRefType_f32_1D *out,
...
// Golden Model 
static void ref_vector_scale(StridedMemRefType_f32_1D *C, StridedMemRefType_f32_1D *A, float val) {
...
int main(int argc, char **argv) {
  ...
  for(int test = 1; test <= 3; test++) {
      ...
      _mlir_ciface_vector_scale(&C, &A, random_val);
      
      // Esecuzione Golden Standard in C passando lo stesso valore scalare
      ref_vector_scale(&Cref, &A, random_val);
